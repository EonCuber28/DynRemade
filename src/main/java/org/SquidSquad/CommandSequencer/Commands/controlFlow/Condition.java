...
public class Condition {
    ...
    public Condition(int line, String opType, boolean in1, boolean in2){
        Part1 = in1;
        Part2 = in2;
        setCondition(opType);
    ...
    public Condition(int line, String opType, String in1, boolean in2){
        Part1 = in1;
        Part2 = in2;
        setCondition(opType);
    ...
    public Condition(int line, String opType, boolean in1, String in2){
        Part1 = in1;
        Part2 = in2;
        setCondition(opType);
        Part1Type = InTypes.bool;
    ...
    public Condition(int line, String opType, String in1, String in2){
        Part1 = in1;
        Part2 = in2;
        setCondition(opType);
        Part1Type = InTypes.var;
    ...
    public Condition(int line, String opType, Condition in1, Condition in2){
        Part1 = in1;
        Part2 = in2;
        setCondition(opType);
    ...
    public Condition(int line, String opType, boolean in1, Condition in2){
        Part1 = in1;
        Part2 = in2;
        setCondition(opType);
        Part1Type = InTypes.bool;
    ...
    public Condition(int line, String opType, Condition in1, boolean in2){
        Part1 = in1;
        Part2 = in2;
        setCondition(opType);
        Part1Type = InTypes.condition;
    ...
    public Condition(int line, String opType, String in1, Condition in2){
        Part1 = in1;
        Part2 = in2;
        setCondition(opType);
        Part1Type = InTypes.var;
    ...
    public Condition(int line, String opType, Condition in1, String in2){
        Part1 = in1;
        Part2 = in2;
        setCondition(opType);
        Part1Type = InTypes.condition;
