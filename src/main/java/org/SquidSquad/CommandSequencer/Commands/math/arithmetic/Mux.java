...
public class Mux extends Command {
    ...
    public Mux(int line, String in1, double in2, String out){
        super(line, CommandType.Mux,new String[]{in1,String.valueOf(in2)},out);
        inCon = MathInCon.I2O1;
        this.in2 = in2;
    }
    public Mux(int line, double in1, String in2, String out){
        super(line, CommandType.Mux,new String[]{String.valueOf(in1),in2},out);
        inCon = MathInCon.I2O1;
        this.in1 = in1;
    }
    public Mux(int line, double in1, double in2, String out){
        super(line, CommandType.Mux,new String[]{String.valueOf(in1),String.valueOf(in2)},out);
        inCon = MathInCon.I2O1;
        this.in1 = in1;
        this.in2 = in2;
    }
    ...
    public Mux(int line, String in1, double in2){
        super(line, CommandType.Mux,new String[]{in1,String.valueOf(in2)},in1);
        inCon = MathInCon.I2;
        this.in2 = in2;
    }
    public Mux(int line, double in1, String in2){
        super(line, CommandType.Mux,new String[]{String.valueOf(in1),in2},in2);
        inCon = MathInCon.I2;
        this.in1 = in1;
    }
    ...
    public void run(){
        ...
        if (in1 != null || in2 != null){
            if (in1 != null && in2 != null){
                varManager.getVar(OutVarID).Mux(
                        new DynNumber(in1),
                        new DynNumber(in2));
            } else if (in1 != null){
                switch (inCon) {
                    case I1O1 -> varManager.getVar(OutVarID).Mux(
                            new DynNumber(in1),
