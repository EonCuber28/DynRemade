...
public class dynString extends Variable {
    ...
    public dynString(String name, String value){
        ...
        switch (in.getType()){
            ...
            case Json -> {
                ...
                for (Variable key : inKeys){
                    json.append(key.valueToStirng());
                    json.append(":");
                    json.append(inVal.get(key).valueToStirng());
    ...
    public void set(int index, Variable in){
        ...
        String newVal = in.valueToStirng();
